...
async def test_get_cards_appoiment_with_bookings():
    ...
    mock_appointments = [
        type(
            "Appointment",
            (),
            {"id": 1, "date": "2023-10-01", "start_time": "10:00", "end_time": "11:00"},
        )(),
        type(
            "Appointment",
            (),
            {"id": 2, "date": "2023-10-02", "start_time": "12:00", "end_time": "13:00"},
        )(),
    ]

    with patch(
        "bot.keyboards.keyboards_my_book.get_booking_appointment_by_tg_id",
        new=AsyncMock(return_value=mock_appointments),
    ):
